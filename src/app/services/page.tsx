        ...
        <div style={{ maxWidth: 680, margin: '40px auto', padding: '0 24px' }}>
          ...
          <div className="card card-pad">
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <select className="input" value={budget} onChange={e => setBudget(e.target.value)} style={{ maxWidth: '100%' }}>
    ...
    <StoreShell>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 24px' }}>
        {loading ? (
          ...
          <div className="services-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: 24, marginBottom: 48 }}>
            {services.map(s => (
